...
namespace AT.Helpers
{
        ...
        public class PagerTagHelper : TagHelper
        {
            ...
            first.AddCssClass("u-pagination-v1__item u-pagination-v1-4 g-brd-gray-light-v3 g-brd-primary--hover g-rounded-50 g-pa-7-16");
            ...
            previous.AddCssClass("u-pagination-v1__item u-pagination-v1-4 g-brd-gray-light-v3 g-brd-primary--hover g-rounded-50 g-pa-7-16");
            ...
            page.AddCssClass("u-pagination-v1__item u-pagination-v1-4 g-rounded-50 g-pa-7-14");

            if (i == this.List.PageNumber)
            {
                page.AddCssClass("u-pagination-v1-4--active");
                return WrapInListItem(page, "g-hidden-sm-down");
            }
            ...
            next.AddCssClass("u-pagination-v1__item u-pagination-v1-4 g-brd-gray-light-v3 g-brd-primary--hover g-rounded-50 g-pa-7-16");
            ...
            last.AddCssClass("u-pagination-v1__item u-pagination-v1-4 g-brd-gray-light-v3 g-brd-primary--hover g-rounded-50 g-pa-7-16");
            ...
            a.AddCssClass("u-pagination-v1__item u-pagination-v1-4 g-brd-gray-light-v3 g-brd-primary--hover g-rounded-50 g-pa-7-16");
            ...
            output.TagName = "nav";
            var att = new TagHelperAttribute("aria-label", "Page Navigation");
            output.Attributes.Add(att);
            output.TagMode = TagMode.StartTagAndEndTag;
            var ul = CreateUL(output, listItemLinks);
            ...
            private TagBuilder CreateUL(TagHelperOutput output, List<TagBuilder> listItemLinks)
            {
