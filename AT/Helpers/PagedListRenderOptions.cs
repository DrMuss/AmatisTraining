...
namespace AT.Helpers
{
        public class PagedListRenderOptions
        {
            ...
            public static PagedListRenderOptions YewtradePager
            {
                get
                {
                return new PagedListRenderOptions
                {
                    ...
                    DisplayLinkToNextPage = PagedListDisplayMode.Always,
                    DisplayLinkToIndividualPages = true,
                    UlElementClasses = new[] { "list-inline" },
                    ClassToApplyToFirstListItemInPager = "float-left",
                    ClassToApplyToLastListItemInPager = "float-right",
                    LiElementClasses = new[] { "list-inline-item " },
